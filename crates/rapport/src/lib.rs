...
#[expect(
    dead_code,
    reason = "Work still consumes legacy resolved Rules until its phase is rebuilt"
)]
mod rules;
#[expect(
    dead_code,
...
#[expect(
    dead_code,
    reason = "Build and Integrate still consume the legacy proof contract until their phases"
)]
