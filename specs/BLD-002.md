...
### Check the Published Pull Request Candidate

_Given_ Integration has published an explicitly completed candidate
...
_And_ binds proof to the exact published pull-request SHA
_But_ refuses to prove a different local SHA
...
_And_ preserves the active pull request
_And_ directs the developer through the repair Task lifecycle
_But_ does not automatically rerun Build after the last repair Task
