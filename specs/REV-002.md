...
### Carry Acceptance into the Pull Request

_Given_ the exact candidate has current Review proof
_When_ Rapport starts integration
_Then_ the pull request body carries the Review grade, reconciliation, and any
quality-policy exception for the human to read with the code
_But_ Rapport does not publish a duplicate Review status or require a second
Review
